...
namespace CWP\Rpc\Client;

use Swoft\Bean\Annotation\Mapping\Bean;
use Swoft\Bean\Concern\PrototypeTrait;
use Swoft\Connection\Pool\AbstractConnection;
use Swoft\Log\Debug;
use CWP\Rpc\Client\Client as RpcClient;
use CWP\Rpc\Client\Contract\ConnectionInterface;
...
class Connection extends AbstractConnection implements ConnectionInterface
{
    ...
    /**
     * @param \CWP\Rpc\Client\Client $client
     * @param Pool $pool
     *
     * @return Connection
     */
    ...
    /**
     * @return \CWP\Rpc\Client\Client
     */
    public function getClient(): \CWP\Rpc\Client\Client
    {
        return $this->client;
    }
